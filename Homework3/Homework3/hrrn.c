        ...
        if(swapFlag == ENABLE) {
            ...
            if(rear != front) {
                ...
                while(indexFinder != NULL) {
                    double indexOfWaitingTime = (double)(indexFinder->waitingTime + indexFinder->serviceTime) / indexFinder->serviceTime;
                    if(indexOfWaitingTime < minServiceTime) {
                        minServiceTimeProcess = indexFinder;
                        minServiceTime = indexOfWaitingTime;
                    }
